...
namespace KitchenSmartAppliances2.Customs.ItemGroups
{
    public class RawPottedLobster : CustomItemGroup<ItemGroupView>
    {
        ...
        public override GameObject Prefab => ModMW.Bundle.LoadAsset<GameObject>("Raw Potted Lobster").AssignMaterialsByNames();
