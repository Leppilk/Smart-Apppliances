...
using KitchenSmartAppliances2.Customs.ItemGroups;
using KitchenSmartAppliances2.Customs.Items;
using System.Collections.Generic;
using UnityEngine;

namespace KitchenSmartAppliances2.Customs.Dishes
{
    public class LobsterDish : CustomDish
    {
        ...
        public override GameObject IconPrefab => ModMW.Bundle.LoadAsset<GameObject>("Lobster Dish Icon").AssignMaterialsByNames();
